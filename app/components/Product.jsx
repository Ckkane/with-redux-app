...
const Product = ({product, id, title, imgUrl, description, price, popluar, rating}) => {
    ...
    return (
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',flexDirection:'column',height:'450px',minWidth:'350px',padding:'25px 0px'}}>
            <img src={imgUrl} width={250} alt="" srcset="" />
            ...
            <div className={styles.checkout}>
                ...
                <button onClick={()=> dispatch(addToCart(product))} className='btn-red'>Купить</button>
            </div>
        </div>
    )
}
